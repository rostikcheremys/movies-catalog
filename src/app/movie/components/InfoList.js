        ...
        <div className="content-container">
            ...
            <div className="card-info-item">
                ...
                {item.runtime ? (
                    ...
                    <p><i
                        className="bi bi-film"></i> {item.number_of_seasons} {item.number_of_seasons === 1 ? 'Season' : 'Seasons'} ({item.number_of_episodes} {item.number_of_episodes === 1 ? 'episode' : 'episodes'})
                    </p>
                )}
                <p><i className="bi bi-globe2"></i> {item.spoken_languages.map((lang) => lang.english_name).join(", ")}
                </p>
